...
// static list_item twl_sound = {"TWL Son", COLOR_TEXT, files_open_twl_sound};
// static list_item dump_nand = {"Backup NAND", COLOR_TEXT, dumpnand_open};
static list_item titles = {"Applications", COLOR_TEXT, titles_open};
// static list_item pending_titles = {"Applications en attente", COLOR_TEXT, pendingtitles_open};
// static list_item tickets = {"Tickets", COLOR_TEXT, tickets_open};
static list_item ext_save_data = {"Donnees de sauvegarde externes", COLOR_TEXT, extsavedata_open};
// static list_item system_save_data = {"Donnees de sauvegarde système", COLOR_TEXT, systemsavedata_open};
static list_item remote_install = {"Installation a distance", COLOR_TEXT, remoteinstall_open};
// static list_item update = {"Rechercher les mises a jour", COLOR_TEXT, update_open};
...
void mainmenu_open() {
    ...
    list_display("Menu principal", "A: Selection, START: Quitter", NULL, mainmenu_update, mainmenu_draw_top);
}
